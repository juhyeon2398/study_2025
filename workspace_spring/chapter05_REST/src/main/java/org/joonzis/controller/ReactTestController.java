...
public class ReactTestController {
	private final ProductVO[] data = {
        ...
        new ProductVO(7, "통단호박 크랜베리 콕콕 샐러드", "단호박 고유의 맛을 그대로", 22200, "cranberry.jpg", "cranberry-info.jpg"),
        new ProductVO(8, "갈비맛 빅볼 닭가슴살", "균형잡힌 구성으로 제대로 된 한끼!", 35400, "galbi.jpg", "galbi-info.jpg"),
        new ProductVO(9, "갈릭 케이준 치킨 샐러드", "with 홀그레인 머스타드 드레싱", 32400, "garlic.jpg", "garlic-info.jpg"),
        new ProductVO(10, "통단호박 크랜베리 콕콕 샐러드", "단호박 고유의 맛을 그대로", 22200, "cranberry.jpg", "cranberry-info.jpg"),
    };
