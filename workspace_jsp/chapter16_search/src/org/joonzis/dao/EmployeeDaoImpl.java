...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	public List<EmployeeVO> getDepartmentId() {
		return getSqlSession().selectList("select_department_id_list");
	}

	@Override
	public List<EmployeeVO> getSearchEmployees(String departId) {
		return getSqlSession().selectList("select_department_id" ,departId);
	}
	
	@Override
	public List<EmployeeVO> getFilter(Map<String, String> map) {
		return getSqlSession().selectList("select_filter" ,map);
	}
